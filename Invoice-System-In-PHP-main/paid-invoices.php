    ...
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4>Paid Invoices - Completed Transactions</h4>
            </div>
            <div class="panel-body form-group form-group-sm">
                ...
                if($results && $results->num_rows > 0) {
                    echo '<div class="alert alert-success">
                        <strong>Total Paid Invoices:</strong> '.$results->num_rows.' | 
                    ...
                    while($row = $results->fetch_assoc()) {
                        echo '<tr>
                            ...
                            <td>
                                ...
                                <a href="#" data-invoice-id="'.$row['invoice'].'" data-email="'.$row['email'].'" data-invoice-type="'.$row['invoice_type'].'" data-custom-email="'."".'" class="btn btn-success btn-xs email-invoice" title="Email"><span class="glyphicon glyphicon-envelope"></span></a>
                    ...
                    echo '<div class="alert alert-info">No paid invoices found.</div>';
                }
                ?>
            </div>
        </div>
